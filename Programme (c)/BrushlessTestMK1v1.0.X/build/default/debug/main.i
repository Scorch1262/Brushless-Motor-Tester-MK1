...
void main(void){
    ...
    SYSTEM_Initialize();
    ADC_Initialize();
    TMR1_SetInterruptHandler (myServoISR);
    ...
    while (1){
        ADC_SelectChannel(ADC);
        ADC_StartConversion();
        ADC_TemperatureAcquisitionDelay();
        adc_wert = (uint16_t)(ADC_GetConversionResult() / 8.2);
        servocounter = (char)adc_wert;
    }
}
